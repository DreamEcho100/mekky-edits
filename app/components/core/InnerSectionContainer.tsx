...
const classVariantsHandler = cva(
  "relative mx-auto flex w-full h-full max-w-main-max-w flex-col",
  {
    variants: {
      gap: { 8: "gap-8", 16: "gap-16" },
      px: { 16: "px-16", 32: "px-32", 64: "px-64" },
      py: { 16: "py-16", 32: "py-32", 64: "py-64" },
    },
    defaultVariants: { gap: 8, py: 32, px: 16 },
  }
);
