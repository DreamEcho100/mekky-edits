	...
	return (
		<html lang='en'>
			<body>
				...
				<footer className='flex flex-col justify-center items-center sm:items-start sm:flex-row sm:justify-between gap-x-2 gap-y-2 bg-neutral-900 px-8 py-12 text-white'>
